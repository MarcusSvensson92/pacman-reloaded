...
private:
	...
	IDirectSoundBuffer8* m_secondaryBuffersGhostMusicBlue;
	IDirectSound3DBuffer8* m_secondary3DBuffersGhostMusicNormal;
	IDirectSound3DBuffer8* m_secondary3DBuffersGhostMusicBlue;
};
